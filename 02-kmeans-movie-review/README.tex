\section{MapReduce实例：聚类分析}\label{ux5b9eux4f8bux5206ux67902015ux5e74ux4e0aux6620ux7535ux5f71ux7684ux805aux7c7bux5206ux6790}
...
在R版本的Reducer中引入R包e1071，利用\lstinline|kmeans|函数分析数据，将其进行K均值聚类分析。
将聚类数目设置为4，迭代数目设为20次。
